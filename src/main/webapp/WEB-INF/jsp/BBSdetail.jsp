        ...
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-subhead-line"><a href="/memberdetail?id=<%=bbs.getStudentid()%>"><%=bbs.getStudentname()%></a> <%=" 发表于 " + bbs.getCreatetime()%></h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <a href="/memberdetail?id=<%=bbs.getStudentid()%>"><%=bbs.getStudentname()%></a>
                                        </div>
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="#">
                                <div class="form-group">
                                    <label>回复主题</label>
                                    <textarea class="form-control" name="topicdetail" placeholder="内容(不多于1500字)" style="width: 1680px;height: 350px;resize:none;"></textarea>
                                </div>
